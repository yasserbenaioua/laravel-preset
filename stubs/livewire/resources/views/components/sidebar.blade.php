<div x-show="sidebarOpen" class="md:hidden">
    ...
    <div class="fixed inset-0 flex z-40">
        <div x-show="sidebarOpen" 
            ...
            class="flex-1 flex flex-col max-w-xs w-full bg-white transform ease-in-out duration-300">
            <div class="relative flex-1 flex flex-col max-w-xs w-full bg-white">
                <div class="absolute top-0 ltr:right-0 ltr:-mr-12 rtl:left-0 rtl:-ml-12 pt-2">
                ...
                <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                    <div class="flex-shrink-0 flex items-center px-4">
                        <svg viewBox="0 0 317 48" fill="none" xmlns="http://www.w3.org/2000/svg" class="block h-8 w-auto">
                    ...
                    <nav class="mt-5 px-2 space-y-1">                        
                        <x-jet-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                            <x-icons.home :active="request()->routeIs('dashboard')"/>
                            {{ __('Dashboard') }}
                        </x-jet-nav-link>

                        <x-jet-nav-link href="{{ route('profile.show') }}" :active="request()->routeIs('profile.show')">
                            <x-icons.user-circle :active="request()->routeIs('profile.show')"/>
                            {{ __('Profile') }}
                        </x-jet-nav-link>							
                    </nav>
                </div>
...
<div class="hidden md:flex md:flex-shrink-0">
    <div class="flex flex-col w-64">
        ...
        <div class="flex flex-col h-0 flex-1 ltr:border-r rtl:border-l border-gray-200 bg-white">
